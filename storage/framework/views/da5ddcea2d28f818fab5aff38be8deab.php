...
<?php $__env->startSection('body'); ?>
    ...
    <div class="col-sm-12 col-md-9 col-lg-9 ">
        <section id="header" class="row ">
            ...
            <?php if($Current_Usr !== null && $id == $Current_Usr->id): ?>

            <section class="col-sm-3 col-md-3 mx-1 mt-5 col-lg-3 offset-lg-1 mt-3  text-center">
                <a href="<?php echo e(route('profile.index', ['id' => Auth::id()])); ?> "class="custom-link">


                    <img  width="150px" height="150px" src="<?php echo e($Current_Usr->image); ?>"
            ...
            <section class="col-sm-8 col-md-7 col-lg-7  mt-5 ">
                <div class="d-flex gap-2 mx-3">
                    <h1 class="h2 fs-4 mx-2"><?php echo e($Current_Usr->name); ?></h1>
                    <a  href="<?php echo e(route('profile.edit')); ?>" type="button" class="btn btn-primary text-light mb-3">Edit
                        Profile</a>
                ...
                <div class="d-flex gap-4  mx-5">
                    <h6 class="fs-4 mt-2"> <span class="fw-bold fs-5"><?php echo e($follows_user->posts->count()); ?> </span>posts</h6>
                    <a class="followers">
                        <h6 class="fs-5 btn btn-white text-dark" data-toggle="modal" data-target="#followers"><span
                                class="count_followers fw-bold fs-7"><?php echo e($follows_user->followers->count()); ?> </span>followers</h6>
                    </a>
                    <a >
                        <h6 class="fs-5 btn btn-outline-white text-dark" data-toggle="modal" data-target="#following"><span
                                class="count_followings fw-bold fs-7"><?php echo e($follows_user->following->count()); ?> </span>following </h6>
                    </a>

                </div>
                <h2 class="h6 mt-1 fw-bold mx-5"><?php echo e($Current_Usr->bio); ?></h2>
            ...
            <section class="col-sm-3 col-md-3  col-lg-3 offset-lg-1 mt-3  text-center">
                <a href="<?php echo e(route('profile.index', ['id' =>$id ])); ?>" class="custom-link">
                    <img  width="150px" height="150px" src="<?php echo e($user->image); ?>"
                    class=" rounded-circle " alt="">
                </a>
            ...
            <section class="col-sm-8 col-md-8 col-lg-8  mt-5 ">
                <div class="d-flex gap-2 mx-5">
                    <h1 class="h2 fs-4 mx-2"><?php echo e($user->name); ?></h1>
                    <?php if($followingsIdForCurrentUsr->contains($user->id)): ?>
                    <a user-id="<?php echo e($user->id); ?>" class="FollowUser btn btn-primary text-light mb-3">
                        Following
                    </a>
                <?php else: ?>
                    <a user-id="<?php echo e($user->id); ?>" class="FollowUser btn btn-primary text-light mb-3">
                ...
                <h2 class="h6 mt-1 fw-bold mx-5"><?php echo e($user->bio); ?></h2>
        ...
        <section id="bodyPosts" class="row">
            ...
            <?php if($posts_user->posts->count()===0): ?>
            ...
            <?php else: ?>
                <?php $__currentLoopData = $posts_user->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <article class="col-md-3 mx-0 mt-4 w-30 offset-1">
                <a data-bs-toggle="modal" data-bs-target="#exampleModal" post-id="<?php echo e($post->id); ?>" type="button" class="post custom-link" >
                    <div class="container-article">
                        <?php if($post->video == 0): ?>
                        <img src="<?php echo e($post->image_url); ?>" alt="post title" class="image  w-100 h-100" />
                    <?php else: ?>
                        <video controls src="<?php echo e($post->image_url); ?>"  class="image  w-100 h-100"></video>
                    <?php endif; ?>
                        <div class="overlay d-flex justify-content-center align-items-center">
                            <i class="fa-solid fa-heart text-white fs-5"></i>
                            <p class="countLikePost text-white fs-5 mx-2 mt-3"><?php echo e($post->likes->count()); ?></p>
                            <i class="fa-solid fa-comment text-white fs-5 mx-2"></i>
                            <p class="countcommentPost text-white fs-5  mt-3"><?php echo e($post->comments->count()); ?></p>
                        </div>
                    </div>
                </a>
            </article>
        ...
        <section id="bodySave" class="row d-none">
            <?php if($savedPosts->savedposts->count()!==0): ?>
            <article class="col-md-4  mt-4 w-30">
                <a  href="<?php echo e(route('profile.save')); ?>" class="custom-link" type="button">
                    <div class="container-article">
                        <img src="<?php echo e($savedPosts->posts[0]->image_url); ?>" alt="post title" class="image" />
                        <div class="overlay d-flex justify-content-center align-items-center">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-between  main-post-div mb-1">
                                        <div class="d-flex avatar-container">
                                            <img src="<?php echo e($Current_Usr->image); ?>" class="rounded-circle" alt="img" height="35px" width="35px" />
                                            ...
                                            <p class="fs-6 mx-2" style="font-weight: bold"><?php echo e($posts_user->name); ?> </p>
                                        </div>
                                ...
                                <ul class="parent-comments modal-body list-group border-0 p-0 h-50 ">
                                    <li class="list-group-item border-0 p-0">
                                        <div class="d-flex justify-content-start align-items-center gap-1">
                                            ...
                                            <div class="d-flex">
                                                <p class="fs-6 mx-2" style="font-weight: bold"><?php echo e($posts_user->name); ?> </p>
                                                <p class="caption mx-1" style="font-size:15px;"> <?php echo e($posts_user->caption); ?> </p>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="postIcon col-4 col-lg-4 col-md-6 col-sm-6 d-flex align-items-center gap-3">
                                        ...
                                        <a type="button" class="like-btn" data-post-id="<?php echo e($post->id); ?>" data-user-id="<?php echo e($post->user_id); ?>">
        ...
        <div class="modal fade" id="followers">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content ">
                    ...
                    <!---------List of followers---------------------->
                    <ul User-id=<?php echo e($user->id); ?> class="parentFollowers modal-body list-group border-0 mt-3">
        ...
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content ">
                ...
                <div class="mt-3 ">
                    ...
                    <!------------List of following-------------->
                    <ul id="bodyPeople" user-id=<?php echo e($user->id); ?> class="parentFollowings list-following modal-body list-group border-0 mt-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Instagram-Clone\resources\views/profile/index.blade.php ENDPATH**/ ?>