...
<nav class="navbar flex-column align-items-start">
    ...
    <div class="side-two w-100 flex-grow-1">
        <a id="home-navbar" class="nav-link d-flex align-items-center p-2 links-navbar active-navbar"
            data-img-src-default="<?php echo e(asset('images/home24x24.png')); ?>"
            data-img-src="<?php echo e(asset('images/homefill24x24.png')); ?>" aria-current="page" href="/">
            <img class="me-2" src="<?php echo e(asset('images/home24x24.png')); ?>" alt="dog">
            <span class="desc">Home</span>
        </a>
        <a id="offcanvasToggleSearch" class="nav-link d-flex links-navbar align-items-center p-2 " aria-current="page"
            data-img-src-default="<?php echo e(asset('images/search24x24.png')); ?>"
            data-img-src="<?php echo e(asset('images/searchfill24x24.png')); ?>" href="#" data-bs-toggle="offcanvas"
            data-bs-target="#search" aria-controls="offcanvasScrolling">
            <img class="me-2" src="<?php echo e(asset('images/search24x24.png')); ?>" alt="dog">
        ...
        <a id="offcanvasToggleNotify" class="nav-link d-flex links-navbar align-items-center p-2 " aria-current="page"
            href="#" data-bs-toggle="offcanvas" data-img-src-default="<?php echo e(asset('images/heart24x24.png')); ?>"
            data-img-src="<?php echo e(asset('images/heartfill24x24.png')); ?>" data-bs-target="#notify"
            aria-controls="offcanvasScrolling">
            <div class="position-relative" id="notify-ball">
                <img class="me-2" src="<?php echo e(asset('images/heart24x24.png')); ?>" alt="dog">
            </div>
            <span class="desc">Notification</span>
        </a>
        <a id="modalCreate" class="nav-link d-flex align-items-center links-navbar p-2 "
            data-img-src-default="<?php echo e(asset('images/tab24x24.png')); ?>"
            data-img-src="<?php echo e(asset('images/tabfill24x24.png')); ?>" data-bs-toggle="modal" data-bs-target="#create-post"
            aria-current="page" href="#">
            <img class="me-2" src="<?php echo e(asset('images/tab24x24.png')); ?>" alt="dog">
            <span class="desc">Create</span>
        </a>
        <a id="profile-navbar" class="nav-link d-flex align-items-center links-navbar p-2 "
            data-img-src-default="<?php echo e(auth()->user()->image); ?>" data-img-src="<?php echo e(auth()->user()->image); ?>"
            aria-current="page" href="<?php echo e(route('profile.index', ['id' => Auth::id()])); ?>">
            <img id="img-user-profile" width="24px" height="24px" src="<?php echo e(auth()->user()->image); ?>"
    ...
    <div class="side-thrid desc">
        <div class="dropup dropup-center">
            <a class="nav-link p-2  dropdown-toggle"id="dropdownMenuButton" data-bs-toggle="dropdown" href="#"
                ...
                <a class="nav-link p-2  dropdown-toggle"id="dropdownMenuButton" data-bs-toggle="dropdown" href="#"
                    aria-expanded="false">
                    <img class="me-2" src="<?php echo e(asset('images/menu24x24.png')); ?>" alt="dog">
                    <span>More</span>
                </a>
...
<div class="modal fade" id="create-post" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog  modal-dialog-centered" id="modal-create-post" role="document">
        <form id="uploadForm" class="w-100" action="<?php echo e(route('posts.store')); ?>" method="POST"
...
<?php /**PATH C:\xampp\htdocs\Instagram-Clone\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>