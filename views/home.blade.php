...
@section('body')
                ...
                @foreach ($suggestedUsers as $suggestedUser)
                    @if ($suggestedUser->is_admin != 1)
                        <div class="d-flex flex-column align-items-center m-2">
                            ...
                            <p>{{ Str::limit($suggestedUser->name, 12) }}</p>
                        </div>
                    @endif
                @endforeach
            </div>
                                                    ...
                                                    @foreach ($threePosts as $t_post)
                                                        ...
                                                        @foreach ($posts as $image)
                                                            @if ($image->user_id == $post->user->id)
                                                                <div class="col-4">
                                                                    <img src="{{ $image->image_url }}" width="80vh" height="100vh">
                                                                </div>
                                                            @endif
                                                        @endforeach
                                                    @endforeach
                                ...
                                <ul class="dropdown-menu" aria-labelledby="btn-emotion">
                                    <div class="container">
                                        <ul class="list-inline emotion-list scrollable-menu" data-bs-emoo="{{ $post->id }}" id="emoji-{{ $post->id }}">
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">😍</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">😂</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">😢</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">👏</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🔥</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🎉</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">💯</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">❤️</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🤣</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🤣</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">😮</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">😍</li>
                                            ...
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🏂</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🏌</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🏌️‍♂️</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🏌️‍♀️</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🏄</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🏄‍♂️</li>
                                            <li class="list-inline-item list-inline-item-{{ $post->id }}">🏄‍♀️</li>
    ...
    <div class="col-3 d-none d-lg-block mt-4">
        ...
        <div class="card mb-3 pb-3 pt-3">
            @foreach ($suggestedUsers as $suggestedUser)
                @if ($suggestedUser->id != Auth::id() && !$followingsIds->contains($suggestedUser->id) && $suggestedUser->is_admin != 1)
